...
const lovesCodeChecker = x => x === true ? true : false;
...
const filtered = myNumbers.filter(e => e > 100 ? e : null);
...
const total = myNumbers.reduce((a, c) => a += c , 0)
...
const enemies = people.filter((e, i) => (e.friend !== true) ? e : null);
...
const totallyAwesome = people.reduce((a, c) => c.awesomeLevel += a, 0);
