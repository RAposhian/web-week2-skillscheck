...
const faveColors = ['orange', 'black', 'blue'];
...
const me = {
   firstName: 'Ryan',
   superHeroName: 'Steve Miller the Man of the Accounts',
   homeTown: 'Bountiful',
   superPowers: ['Balance the Books', 'File this Paper', 'Receive Wedgie'],
...
const setColor = arr => {
   ...
   background(newArr[0], newArr[1], newArr[2]);
}
